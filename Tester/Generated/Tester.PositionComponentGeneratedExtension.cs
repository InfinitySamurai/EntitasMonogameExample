...
namespace Entitas {
    ...
    public partial class Entity {
        ...
        public Tester.PositionComponent position { get { return (Tester.PositionComponent)GetComponent(CoreComponentIds.Position); } }
        public bool hasPosition { get { return HasComponent(CoreComponentIds.Position); } }

        public Entity AddPosition(float newX, float newY) {
            var component = CreateComponent<Tester.PositionComponent>(CoreComponentIds.Position);
            component.x = newX;
            component.y = newY;
